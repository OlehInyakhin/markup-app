        ...
        <div className="footer__content">
          <div className="footer__main">
            <div className="footer__brand">
              <img src={footerLogoSrc} alt="Footer logo" className="footer__logo" />
              <form className="footer__subscription-form" onSubmit={handleSubscribe}>
            ...
            <div className="footer__links">
              <div className="footer__column">
                ...
                <ul className="footer__list">
                  <li><a href="#" className="footer__link">עלינו</a></li>
                  <li><a href="#" className="footer__link">עבודות</a></li>
                  <li><a href="#" className="footer__link">קריירה</a></li>
                  <li><a href="#" className="footer__link">בלוג</a></li>
                  <li><a href="#" className="footer__link">צור קשר</a></li>
              ...
              <div className="footer__column">
                ...
                <ul className="footer__list">
                  <li><a href="#" className="footer__link">פיתוח</a></li>
                  <li><a href="#" className="footer__link">עיצוב ואסטרטגיה</a></li>
                  <li><a href="#" className="footer__link">שיווק דיגיטלי</a></li>
                  <li><a href="#" className="footer__link">UX/UI</a></li>
                </ul>
              </div>
              ...
              <div className="footer__column footer__column--socials">
                ...
                <img src={footerLogoSrc} alt="Footer logo" className="footer__logo" width={43} height={20} />
              </div>
            </div>
          </div>
          
          <div className="footer__bottom">
            <img src={imageSrc} width={1720} height={392} alt="HYBRID" className="footer__image" loading="lazy" />
            <div className="footer__copyright">
              <p>&copy; {new Date().getFullYear()} SPIN. All rights reserved.</p>
              <div className="footer__legal">
                <a href="#" className="footer__link">מדיניות</a>
                <a href="#" className="footer__link">פרטיות</a>
              </div>
            </div>
